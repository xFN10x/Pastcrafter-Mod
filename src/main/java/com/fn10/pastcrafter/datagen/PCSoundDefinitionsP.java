...
public class PCSoundDefinitionsP extends SoundDefinitionsProvider {
        ...
        public static final SoundEvent BINDING_TABLE_BIND_SOUND = SoundEvent.createVariableRangeEvent(
                        ResourceLocation.fromNamespaceAndPath(PastCrafer.MID, "binding_table_bind"));
        ...
        public void registerSounds() {
                ...
                this.addSound(BINDING_TABLE_BIND_SOUND, "bind1", 1f, "pastcraft.subtitle.bind");
        }
